...
return [
    ...
    '<a href="{invite}">Join this server</a> to be the first reviewer!' => '<a href="{invite}">›llk elestirmen olmak icin</a> bu sunucuya gir!',
    'Language' => 'Dil',
    'Login' => 'Giris Yap',
    'Logout' => 'Cikis Yap',
    ...
    'Why don\'t you <a href="{reviewUrl}">review <strong>{serverName}</strong></a>?' => 'Neden <a href="{reviewUrl}">{serverName} <strong>elestirmiyorsun</strong></a>?',    
